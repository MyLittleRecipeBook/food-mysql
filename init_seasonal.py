    ...
    try:
        with open(csv_file_path, mode='r') as file:
            ...
            for row in csv_reader:
                ...
                sql = f"INSERT INTO {table_name} (seasonal_name, seasonal_month, seasonal_image) VALUES ('{row[0]}', {row[1]}, '{row[2]}')"
                print(f"seasonal data {row[0]} inserted")
...
if __name__ == '__main__':
    ...
    user = 'test'
    password = 'test1234'
    csv_file_path = 'data/seasonal.csv'
    table_name = 'Seasonal'
